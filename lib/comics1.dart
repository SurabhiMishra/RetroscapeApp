...
List<String> array = [
  ...
  "Chacha Chaudhary:Pran's all-time favourite comic book Chacha Choudhary is rooted in India. The series is about a wise man, who solves problems with his exceptional intellect along with his friend 'Sabu' an inhabitant of the planet Jupiter.",
  "Published since June 19, 1978, it chronicles the life of the title character, a cat named Garfield (named after Davis's grandfather); his owner, Jon Arbuckle; and Arbuckle's dog, Odie"
];
